export default function AboutPage () {
    return(
        <>
            <div className="mt-36 px-6 md:px-[10%]">
                ...
                <div className="flex justify-between mb-36 mt-12">
                    <div className="flex flex-col w-full font-bold tracking-wide leading-7">
                        ...
                        <p className="mb-8">Wij zijn Lars, Jamie en Annabel, drie enthousiaste studenten die allemaal één grote passie delen: festivals. Wij houden ervan om die unieke sfeer te beleven, de energie van de menigte te voelen en onze favoriete artiesten te zien optreden. Maar als trouwe festivalgangers weten we ook dat een festival eigenlijk een marathon is. Soms sta je wel 10 tot 12 uur op de benen, dansend, genietend, maar laten we eerlijk zijn, tegen de avond wordt dat soms best zwaar.</p>
            ...
            <div className="inset-0 w-full h-[50vh] bg-center bg-no-repeat object-cover opacity-60">
                <img src="../rave-background4.jpg" alt="Homepage background image of rave" className="overflow-hidden object-cover object-center h-full w-full" />
            </div>
        </>
    )
}