...
export default function ContactForm() {
    ...
    return (
        <div className="md:w-5/12 md:mr-12 h-full flex flex-col ml-2 justify-center items-center font-bold tracking-wide leading-7">
            <p className="w-full">
                Stuur een email naar 
                <span className="underline">
                    &nbsp;info.xurro@gmail.com
                </span>
                <button className="ml-1 px-1 border rounded" onClick={() => copyToClipboard("info.xurro@gmail.com")}>
            ...
            <textarea className="font-semibold text-black p-1 w-full h-16 mt-1" name="mailbody" onChange={(e) => {handleMailBody(e.target.value)}}/>
