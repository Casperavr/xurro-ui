                ...
                <div className="w-full h-1/2 md:w-1/2 md:h-full font-semibold mt-12">
                    ...
                    <div className="flex flex-col ml-2">
                        <p className="text-xs h-4">
                            ...
                            <button className="text-xs h-5 ml-1 px-1 border rounded" onClick={() => copyToClipboard("info.xurro@gmail.com")}>
                    ...
                    <p className="text-xs h-4 ml-2">Check onze Instagram of Github hieronder</p>
